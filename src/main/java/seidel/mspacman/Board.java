        ...
        for (int y = 0; y < height; ++y) {
            for (int x = 0; x < width; ++x) {
                ...
                if (square[x][y] == 1) {
                    ...
                    if (x == width - 1 || square[x + 1][y] == 0)
                        g.drawLine((x * 20) + 20, y * 20, (x * 20) + 20, (y * 20) + 20);
                    if (y == height - 1 || square[x][y + 1] == 0)
                        g.drawLine(x * 20, (y * 20) + 20, (x * 20) + 20, (y * 20) + 20);
                    ...
                    if (x == width - 1 || square[x + 1][y] == 0)
                        invG.drawLine((x * 20) + 20, y * 20, (x * 20) + 20, (y * 20) + 20);
                    if (y == height - 1 || square[x][y + 1] == 0)
                        invG.drawLine(x * 20, (y * 20) + 20, (x * 20) + 20, (y * 20) + 20);
